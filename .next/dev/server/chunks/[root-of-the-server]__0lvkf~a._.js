...
async function POST(req) {
    try {
        ...
        let instance = (userId ? await prisma.whatsappInstance.findFirst({
            where: {
                locationId,
                userId
            },
        ...
        }) : null) || await prisma.whatsappInstance.findFirst({
            where: {
                locationId
            },
            orderBy: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0lvkf~a._.js.map